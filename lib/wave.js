...
export default function (__usable_environment) {
	...
	(() => {
		...
		var edide = {};
		edide.global = (() =>
			typeof __usable_globalThis.global !== "undefined"
				? __usable_globalThis.global
				: __usable_window.window).call((MODSELF = {}), edide, MODSELF);
		...
		edide.qs = (() =>
			(selector, el = __usable_window.document) =>
				el.querySelector(selector)).call((MODSELF = {}), edide, MODSELF);
		edide.scriptContainer = ((edide) => {
			var createContainer;
			var ref;
			createContainer = () => {
				var s = __usable_window.document.createElement("div");
				s.id = "scripts";
				return s;
			};
			return (ref = edide.qs("#scripts")) != null
				? ref
				: __usable_window.document.body.appendChild(createContainer());
		}).call((MODSELF = {}), edide, MODSELF);
		edide.scriptAdd = ((edide) => (src, cb) => {
			var el = __usable_window.document.createElement("script");
